       ...
       # Loop through the secondary_df to get the data needed
        for k, row_secondary in found_secondary_df.iterrows():
            ...
            if new_sub_entry[secondary_column_to_merge_on] == new_entry[primary_column_to_merge_on]:
                ...
                new_entry[name_of_column].append(new_sub_entry)
...
player_data = mongoize(master_df, salaries_df, 'playerID', 'playerID', "Salary Data")
batting_data = mongoize(master_df, batting_df, 'playerID', 'playerID', "Batting_Data")
